...
Float_t network_get_cost(const NeuronalNetwork_p network, const Float_p labels)
{
    ...
    return get_cost(128, 10, network->layer_5.output_activation_start, labels, network->shared_tmp_floats);
    // [[[end]]]
}
...
Float_t network_get_accuracy(const NeuronalNetwork_p network, const Float_p labels)
{
    ...
    return get_accuracy(128, 10, network->layer_5.output_activation_start, labels);
    // [[[end]]]
}
...
void network_derive_cost(const NeuronalNetwork_p network, const Float_p labels)
{
    ...
    get_cost_derivatives(128, 10, network->layer_5.output_activation_start, labels, network->layer_5.output_activation_error_start, network->shared_tmp_floats);
    // [[[end]]]
}

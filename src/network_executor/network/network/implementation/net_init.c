...
void network_init(const NeuronalNetwork_p network)
{
    ...
    network->layer_0.input_activation_count = 78400;
    ...
    network->layer_0.output_activation_count = 2505120;
    ...
    network->layer_0.batch_count = 100;
    network->layer_0.filter_matrix_width = 25;
    network->layer_0.input_matrix_height = 5;
    network->layer_0.input_matrix_width = 15657;
    network->layer_0.input_matrix_toplayer_elements_count = 28;
    network->layer_0.partial_output_matrix_count = 501024;
    network->layer_0.full_output_matrix_width = 78285;
    ...
    network->layer_1.input_activation_count = 2505120;
    network->layer_1.output_activation_start = network->activations + 2505152;
    network->layer_1.output_activation_error_start = network->activations_errors + 2505152;
    network->layer_1.output_activation_count = 460800;
    network->layer_1.output_p = 100;
    network->layer_1.output_y = 12;
    network->layer_1.output_x = 12;
    network->layer_1.output_f = 32;
    network->layer_1.pooling_layout.relevant_entries_count = 1843200;
    network->layer_1.pooling_layout.num_of_lines = 460800;
    ...
    network->layer_1.pooling_mem.relevant_entries_count = 460800;
    network->layer_1.pooling_mem.relevant_entries_start = network->pooling_mem + 0;
    // convolutional
    network->layer_2.input_activation_start = network->activations + 2505152;
    network->layer_2.input_activation_error_start = network->activations_errors + 2505152;
    network->layer_2.input_activation_count = 460800;
    network->layer_2.output_activation_start = network->activations + 2965952;
    network->layer_2.output_activation_error_start = network->activations_errors + 2965952;
    network->layer_2.output_activation_count = 918400;
    ...
    network->layer_2.batch_count = 100;
    network->layer_2.filter_matrix_width = 800;
    network->layer_2.input_matrix_height = 160;
    network->layer_2.input_matrix_width = 2870;
    network->layer_2.input_matrix_toplayer_elements_count = 384;
    network->layer_2.partial_output_matrix_count = 183680;
    network->layer_2.full_output_matrix_width = 14350;
    ...
    #endif
    // maxpooling
    network->layer_3.input_activation_start = network->activations + 2965952;
    network->layer_3.input_activation_error_start = network->activations_errors + 2965952;
    network->layer_3.input_activation_count = 918400;
    network->layer_3.output_activation_start = network->activations + 3884352;
    network->layer_3.output_activation_error_start = network->activations_errors + 3884352;
    network->layer_3.output_activation_count = 102400;
    network->layer_3.output_p = 100;
    network->layer_3.output_y = 4;
    network->layer_3.output_x = 4;
    network->layer_3.output_f = 64;
    network->layer_3.pooling_layout.relevant_entries_count = 409600;
    network->layer_3.pooling_layout.num_of_lines = 102400;
    network->layer_3.pooling_layout.relevant_columns_per_line = 4;
    network->layer_3.pooling_layout.relevant_columns_start = network->pooling_layout + 1843200;
    network->layer_3.pooling_mem.relevant_entries_count = 102400;
    network->layer_3.pooling_mem.relevant_entries_start = network->pooling_mem + 460800;
    // fully connected
    network->layer_4.input_activation_start = network->activations + 3884352;
    network->layer_4.input_activation_error_start = network->activations_errors + 3884352;
    network->layer_4.input_activation_count = 102400;
    network->layer_4.output_activation_start = network->activations + 3986752;
    network->layer_4.output_activation_error_start = network->activations_errors + 3986752;
    network->layer_4.output_activation_count = 102400;
    network->layer_4.single_input_count = 1024;
    network->layer_4.single_output_count = 1024;
    network->layer_4.batch_count = 100;
    ...
    // fully connected
    network->layer_5.input_activation_start = network->activations + 3986752;
    network->layer_5.input_activation_error_start = network->activations_errors + 3986752;
    network->layer_5.input_activation_count = 102400;
    network->layer_5.output_activation_start = network->activations + 4089152;
    network->layer_5.output_activation_error_start = network->activations_errors + 4089152;
    network->layer_5.output_activation_count = 1000;
    network->layer_5.single_input_count = 1024;
    network->layer_5.single_output_count = 10;
    network->layer_5.batch_count = 100;

...
#define NETWORK_ACTIVATION_SIZE 2615104
#define NETWORK_POOLING_MEM_SIZE 360448
#define NETWORK_WEIGHTS_F_SIZE 1112000
#define NETWORK_POOLING_LAYOUT_SIZE 1441792
#define SHARED_ARRAY_SIZE 1601920
#define SHARED_TMP_ARRAY_SIZE 3203840
// [[[end]]]

...
#define NETWORK_ACTIVATION_SIZE 1304384
#define NETWORK_POOLING_MEM_SIZE 180224
#define NETWORK_WEIGHTS_F_SIZE 1112000
#define NETWORK_POOLING_LAYOUT_SIZE 720896
#define SHARED_ARRAY_SIZE 799200
#define SHARED_TMP_ARRAY_SIZE 1598400
// [[[end]]]

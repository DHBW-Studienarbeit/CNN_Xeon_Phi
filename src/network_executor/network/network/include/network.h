...
#define NETWORK_ACTIVATION_SIZE 4090152
#define NETWORK_POOLING_MEM_SIZE 563200
#define NETWORK_WEIGHTS_F_SIZE 1112000
#define NETWORK_POOLING_LAYOUT_SIZE 2252800
#define SHARED_ARRAY_SIZE 2505120
#define SHARED_TMP_ARRAY_SIZE 5010240
// [[[end]]]

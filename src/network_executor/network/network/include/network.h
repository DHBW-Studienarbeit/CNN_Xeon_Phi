...
#define NETWORK_ACTIVATION_SIZE 2041652
#define NETWORK_POOLING_MEM_SIZE 281600
#define NETWORK_WEIGHTS_F_SIZE 1112000
#define NETWORK_POOLING_LAYOUT_SIZE 1126400
#define SHARED_ARRAY_SIZE 1250720
#define SHARED_TMP_ARRAY_SIZE 2501440
// [[[end]]]

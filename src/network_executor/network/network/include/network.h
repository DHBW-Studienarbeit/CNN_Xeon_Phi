...
#define NETWORK_ACTIVATION_SIZE 5237248
#define NETWORK_POOLING_MEM_SIZE 720896
#define NETWORK_WEIGHTS_F_SIZE 1112000
#define NETWORK_POOLING_LAYOUT_SIZE 2883584
#define SHARED_ARRAY_SIZE 3207680
#define SHARED_TMP_ARRAY_SIZE 6415360
// [[[end]]]
